...
def rrarm_positions_publisher():
	...
	rate = rospy.Rate(80) #Rate 80 Hz
		...
		rospy.sleep(1)
		joint1current_position, joint2current_position = rrarm_pushing_object(joint1initial_position, joint2initial_position, move_step_joint1, move_step_joint2)
		rospy.sleep(0.2)
		joint1current_position, joint2current_position = rrarm_roll_back(joint1current_position, joint2current_position, step_upward1, step_upward2)
		rospy.sleep(1)
